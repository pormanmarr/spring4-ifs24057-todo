...
import org.delcom.todos.controllers.HomeController;
...
class HomeControllerUnitTest {
    ...
    void hello_ShouldReturnWelcomeMessage() throws Exception {
        ...
        // Assert
        assertEquals("Hai Porman Marsaulina, selamat datang di pengembangan aplikasi dengan Spring Boot!", result);
    }
